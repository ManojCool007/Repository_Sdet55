	...
	public static void main(String[] args) throws InterruptedException {
		...
		for(String id:all_id)
		{
			...
			else
			{
				...
				act.sendKeys(dept, "Davanagere").perform();
				WebElement dest = driver.findElement(By.xpath("//input[@id='goingTo']"));
				act.moveToElement(dest).perform();
				act.sendKeys(dest, "Hubli").perform();
			}
